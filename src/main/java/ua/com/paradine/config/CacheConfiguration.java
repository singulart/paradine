...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, ua.com.paradine.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            createCache(cm, ua.com.paradine.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            createCache(cm, ua.com.paradine.domain.User.class.getName(), jcacheConfiguration);
            createCache(cm, ua.com.paradine.domain.Authority.class.getName(), jcacheConfiguration);
