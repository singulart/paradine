package unsafe.delete.thehipsta.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            createCache(cm, unsafe.delete.thehipsta.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            createCache(cm, unsafe.delete.thehipsta.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            ...
            createCache(cm, unsafe.delete.thehipsta.domain.PopularTime.class.getName(), jcacheConfiguration);
