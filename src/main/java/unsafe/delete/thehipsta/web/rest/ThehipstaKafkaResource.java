...
@RestController
@RequestMapping("/api/thehipsta-kafka")
public class ThehipstaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ThehipstaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ThehipstaKafkaResource(KafkaProperties kafkaProperties) {
