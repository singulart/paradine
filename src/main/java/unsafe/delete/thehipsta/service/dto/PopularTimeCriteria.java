...
/**
 * Criteria class for the {@link unsafe.delete.thehipsta.domain.PopularTime} entity. This class is used
 * in {@link unsafe.delete.thehipsta.web.rest.PopularTimeResource} to receive all the possible filtering options from
