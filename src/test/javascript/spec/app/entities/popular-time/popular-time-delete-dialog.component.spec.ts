...
describe('Component Tests', () => {
  describe('PopularTime Management Delete Component', () => {
    let comp: PopularTimeDeleteDialogComponent;
    let fixture: ComponentFixture<PopularTimeDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .compileComponents();
      fixture = TestBed.createComponent(PopularTimeDeleteDialogComponent);
