...
import { WorkingHoursComponent } from 'app/entities/working-hours/working-hours.component';
...
describe('Component Tests', () => {
  describe('WorkingHours Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.workingHours && comp.workingHours[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
